...
plt.legend(('5 Min Leaf', '50 Min Leaf'), loc = 'lower right')
print('ACCURACY LIST FOR 5 MIN LEAF:');print(accuracylist)
print('ACCURACY LIST FOR 50 MIN LEAF:');print(accuracylist2)
